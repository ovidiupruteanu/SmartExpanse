 ...
 */
metadata {
    definition(name: "Fibaro Smart Implant DHT22", namespace: "ovidiupruteanu", author: "Ovidiu Pruteanu") {
    ...
    tiles(scale: 2) {
        valueTile("temperature", "device.temperature", inactiveLabel: false, width: 2, height: 2) {
            state "temperature", label: '${currentValue}°', icon:"st.Weather.weather12",
                    backgroundColors: [
